...
def parse_args():
    ...
    training_group.add_argument('--qwen2_model', default='qwen2_1p5b', choices=['qwen2_0p5b', 'qwen2_1p5b', 'qwen2_7b'], type=str, help="Type of Qwen2 model to use for initialization.")
